...
export default function LandingScreen() {
  return (
    <div className="relative min-h-screen pt-16 flex items-center justify-center overflow-hidden bg-[#050505]">
      {/* Decorative Glows */}
      ...
      <div className="container mx-auto px-6 text-center z-10">
        ...
        <motion.p 
          ...
          className="text-zinc-400 text-lg md:text-xl max-w-2xl mx-auto mb-10 font-medium"
        >
        ...
        >
          ...
          <div className="relative bg-[#0A0A0A] border border-white/10 rounded-[2.5rem] overflow-hidden aspect-video shadow-2xl">
            <img 
